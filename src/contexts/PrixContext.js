...
const initialServices = (prixFixe) => [
  ...
  { id: 22, name: "2 séances/semaine", quantity: 2, prix: prixFixe * 0.975, type: "weekly", remise: 2.5 },
  { id: 23, name: "3 séances/semaine", quantity: 3, prix: prixFixe * 0.95, type: "weekly", remise: 5 },
  { id: 24, name: "4 séances/semaine", quantity: 4, prix: prixFixe * 0.925, type: "weekly", remise: 7.5 },
  { id: 25, name: "5 séances/semaine", quantity: 5, prix: prixFixe * 0.90, type: "weekly", remise: 10 },
  { id: 31, name: "1 séance/semaine", quantity: 12, prix: prixFixe * 0.95, type: "12weeks", remise: 5 },
  { id: 32, name: "2 séances/semaine", quantity: 24, prix: prixFixe * 0.90, type: "12weeks", remise: 10 },
  { id: 33, name: "3 séances/semaine", quantity: 36, prix: prixFixe * 0.875, type: "12weeks", remise: 12.5 },
  { id: 34, name: "4 séances/semaine", quantity: 48, prix: prixFixe * 0.85, type: "12weeks", remise: 15 },
  { id: 35, name: "5 séances/semaine", quantity: 60, prix: prixFixe * 0.80, type: "12weeks", remise: 20 },
];
